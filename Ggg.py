...
for xcTeam in range(1000):
	rr = random.randint
	rc = random.choice
	ngentot1 = f"Mozilla/5.0 (Linux; U; Android 8.0; Pixel 2 XL Build/RP1A.{str(rr(111111,199999))}.001).002).011).003).004).014)[FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/IndosatOoredoo;FBMF/Realme;FBBD/Realme;FBDV/Pixel 2 XL;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot1 in ngentott:pass
	else:ngentott.append(ngentot1)
	ngentot2 = f"Mozilla/5.0 (Linux; U; Android 10.0.0; PBEM00 Build/OPM1.{str(rr(111111,199999))}.001).002).011).003).004).005).012).015).016)[FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.orca;FBLC/th_TH;FBBV/{str(rr(200000000,299999999))};FBCR/TRUE-H;FBMF/OPPO;FBBD/OPPO;FBDV/PBEM00;FBSV/11.0.0;FBCA/armeabi-v7a:armeabi;FBDM/"+"{density=2.0,width=1424,height=720};FB_FW/1;]"
	if ngentot2 in ngentott:pass
	else:ngentott.append(ngentot2)
	ngentot3 = f"Mozilla/5.0 (Linux; U; Android 9.0; YAL-L41 Build/HUAWEIYAL-L41.{str(rr(111111,199999))}.001).002).011).003).004).005) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/YAL-L41;FBSV/6.0.0;FBCA/armeabi-v7a:armeabi;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot3 in ngentott:pass
	else:ngentott.append(ngentot3)
	ngentot4 = f"Mozilla/5.0 (Linux; U; Android 8.0; M2007J3SG Build/SKQ1.{str(rr(111111,199999))}.{str(rr(111111,199999))}.001).002).011).003).004).005) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/IndosatOoredoo;FBMF/Realme;FBBD/Realme;FBDV/M2007J3SG;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"(density=3.0,width=1080,height=1920);FB_FM/1;]"
...
def scarpping_ua():
    ...
    header = {"apikey": "AM07DHeME8yI8BXV4Wiiaf4"}
  ...
  #  os.system('clear')
    try:
        ...
        if response.status_code == 200:
            ...
            uascrap.append("Mozilla/5.0 (Linux; Android 8.0; SAMSUNG SM-G900F Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36")
    except requests.exceptions.ConnectionError:
        uascrap.append("Mozilla/5.0 (Linux; Android 8.0; SAMSUNG SM-G900F Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36")
